...
const funCategories = {
    ...
    'magic-fantasy': {
        label: 'Magic & Fantasy',
        labelEs: 'Magia y Fantasía',
        icon: 'fa-solid fa-hat-wizard',
        color: '#9C27B0',
        words: [
            { word: 'Wizard', spanish: 'Mago' },
            { word: 'Dragon', spanish: 'Dragón' },
            { word: 'Unicorn', spanish: 'Unicornio' },
            { word: 'Mermaid', spanish: 'Sirena' },
            { word: 'Fairy', spanish: 'Hada' },
            { word: 'Magic Wand', spanish: 'Varita Mágica' },
            { word: 'Flying Carpet', spanish: 'Alfombra Mágica' },
            { word: 'Ghost', spanish: 'Fantasma' },
            { word: 'Monster', spanish: 'Monstruo' },
            { word: 'Alien', spanish: 'Extraterrestre' },
            { word: 'Castle', spanish: 'Castillo' },
            { word: 'King', spanish: 'Rey' },
            { word: 'Queen', spanish: 'Reina' },
            { word: 'Knight', spanish: 'Caballero' },
            { word: 'Princess', spanish: 'Princesa' },
            { word: 'Prince', spanish: 'Príncipe' },
            { word: 'Pirate', spanish: 'Pirata' },
            { word: 'Treasure Chest', spanish: 'Cofre del Tesoro' },
            { word: 'Potion', spanish: 'Poción' },
            { word: 'Ninja', spanish: 'Ninja' },
        ]
    },
    'jobs-professions': {
        label: 'Jobs & Professions',
        labelEs: 'Trabajos y Profesiones',
        icon: 'fa-solid fa-user-doctor',
        color: '#0288D1',
        words: [
            { word: 'Doctor', spanish: 'Doctor' },
            { word: 'Nurse', spanish: 'Enfermera/o' },
            { word: 'Police Officer', spanish: 'Policía' },
            { word: 'Firefighter', spanish: 'Bombero' },
            { word: 'Teacher', spanish: 'Profesor/a' },
            { word: 'Astronaut', spanish: 'Astronauta' },
            { word: 'Chef', spanish: 'Chef/Cocinero' },
            { word: 'Farmer', spanish: 'Granjero/a' },
            { word: 'Singer', spanish: 'Cantante' },
            { word: 'Dancer', spanish: 'Bailarín/a' },
            { word: 'Construction Worker', spanish: 'Constructor' },
            { word: 'Pilot', spanish: 'Piloto' },
            { word: 'Bus Driver', spanish: 'Conductor de Bus' },
            { word: 'Dentist', spanish: 'Dentista' },
            { word: 'Veterinarian', spanish: 'Veterinario/a' },
            { word: 'Scientist', spanish: 'Científico/a' },
            { word: 'Mechanic', spanish: 'Mecánico' },
            { word: 'Artist', spanish: 'Artista' },
            { word: 'Photographer', spanish: 'Fotógrafo/a' },
            { word: 'Mail Carrier', spanish: 'Cartero' },
        ]
    },
    'bugs-insects': {
        label: 'Bugs & Insects',
        labelEs: 'Bichos e Insectos',
        icon: 'fa-solid fa-bug',
        color: '#827717',
        words: [
            { word: 'Spider', spanish: 'Araña' },
            { word: 'Butterfly', spanish: 'Mariposa' },
            { word: 'Bee', spanish: 'Abeja' },
            { word: 'Ant', spanish: 'Hormiga' },
            { word: 'Worm', spanish: 'Gusano' },
            { word: 'Ladybug', spanish: 'Mariquita' },
            { word: 'Grasshopper', spanish: 'Saltamontes' },
            { word: 'Snail', spanish: 'Caracol' },
            { word: 'Fly', spanish: 'Mosca' },
            { word: 'Mosquito', spanish: 'Mosquito' },
            { word: 'Beetle', spanish: 'Escarabajo' },
            { word: 'Caterpillar', spanish: 'Oruga' },
            { word: 'Dragonfly', spanish: 'Libélula' },
            { word: 'Centipede', spanish: 'Ciempiés' },
            { word: 'Cockroach', spanish: 'Cucaracha' },
        ]
    },
    'instruments-music': {
        label: 'Instruments & Music',
        labelEs: 'Instrumentos y Música',
        icon: 'fa-solid fa-guitar',
        color: '#6D4C41',
        words: [
            { word: 'Playing Guitar', spanish: 'Tocar la Guitarra' },
            { word: 'Playing Piano', spanish: 'Tocar el Piano' },
            { word: 'Drumming', spanish: 'Tocar la Batería' },
            { word: 'Singing with a Microphone', spanish: 'Cantar con Micrófono' },
            { word: 'Playing Violin', spanish: 'Tocar el Violín' },
            { word: 'Playing Flute', spanish: 'Tocar la Flauta' },
            { word: 'Playing Trumpet', spanish: 'Tocar la Trompeta' },
            { word: 'Playing Saxophone', spanish: 'Tocar el Saxofón' },
            { word: 'Playing Harp', spanish: 'Tocar el Arpa' },
            { word: 'Playing Accordion', spanish: 'Tocar el Acordeón' },
            { word: 'Playing Triangle', spanish: 'Tocar el Triángulo' },
            { word: 'Playing Maracas', spanish: 'Tocar las Maracas' },
            { word: 'Playing Xylophone', spanish: 'Tocar el Xilófono' },
            { word: 'DJ scratching', spanish: 'DJ mezclando' },
            { word: 'Conducting an Orchestra', spanish: 'Dirigir una Orquesta' },
        ]
    },
    'toys-games': {
        label: 'Toys & Games',
        labelEs: 'Juguetes y Juegos',
        icon: 'fa-solid fa-puzzle-piece',
        color: '#D81B60',
        words: [
            { word: 'Yo-yo', spanish: 'Yoyó' },
            { word: 'Flying a Kite', spanish: 'Volar una Cometa' },
            { word: 'Teddy Bear', spanish: 'Oso de Peluche' },
            { word: 'Building Blocks', spanish: 'Bloques de Construcción' },
            { word: 'Solving a Puzzle', spanish: 'Armar un Rompecabezas' },
            { word: 'Action Figure', spanish: 'Figura de Acción' },
            { word: 'Doll', spanish: 'Muñeca' },
            { word: 'Playing with Slime', spanish: 'Jugar con Slime' },
            { word: 'Play-Doh', spanish: 'Plastilina' },
            { word: 'Remote Control Car', spanish: 'Carro a Control Remoto' },
            { word: 'Water Gun', spanish: 'Pistola de Agua' },
            { word: 'Blowing Bubbles', spanish: 'Hacer Burbujas' },
            { word: 'Spinning Top', spanish: 'Trompo' },
            { word: 'Rubik\'s Cube', spanish: 'Cubo Rubik' },
            { word: 'Trampoline', spanish: 'Saltarín / Trampolín' }
        ]
    },
    'space-universe': {
        label: 'Space & Universe',
        labelEs: 'Espacio y Universo',
        icon: 'fa-solid fa-rocket',
        color: '#1A237E',
        words: [
            { word: 'Astronaut', spanish: 'Astronauta' },
            { word: 'Rocket Ship', spanish: 'Cohete' },
            { word: 'Alien', spanish: 'Extraterrestre' },
            { word: 'UFO', spanish: 'Platillo Volador' },
            { word: 'Sun', spanish: 'Sol' },
            { word: 'Moon', spanish: 'Luna' },
            { word: 'Star', spanish: 'Estrella' },
            { word: 'Shooting Star', spanish: 'Estrella Fugaz' },
            { word: 'Planet Earth', spanish: 'Planeta Tierra' },
            { word: 'Mars', spanish: 'Marte' },
            { word: 'Black Hole', spanish: 'Agujero Negro' },
            { word: 'Telescope', spanish: 'Telescopio' },
            { word: 'Meteor', spanish: 'Meteoro' },
            { word: 'Satellite', spanish: 'Satélite' },
            { word: 'Floating in space', spanish: 'Flotando en el espacio' },
        ]
    },
    'dinosaurs-prehistoric': {
        label: 'Dinosaurs & Prehistoric',
        labelEs: 'Dinosaurios y Prehistoria',
        icon: 'fa-solid fa-bone',
        color: '#4E342E',
        words: [
            { word: 'T-Rex', spanish: 'T-Rex' },
            { word: 'Triceratops', spanish: 'Triceratops' },
            { word: 'Pterodactyl', spanish: 'Pterodáctilo' },
            { word: 'Stegosaurus', spanish: 'Estegosaurio' },
            { word: 'Brachiosaurus', spanish: 'Braquiosaurio' },
            { word: 'Velociraptor', spanish: 'Velociraptor' },
            { word: 'Dinosaur Egg', spanish: 'Huevo de Dinosaurio' },
            { word: 'Fossil', spanish: 'Fósil' },
            { word: 'Caveman', spanish: 'Cavernícola' },
            { word: 'Mammoth', spanish: 'Mamut' },
            { word: 'Volcano erupting', spanish: 'Volcán en erupción' },
            { word: 'Roaring like a dinosaur', spanish: 'Rugir como dinosaurio' },
            { word: 'Stomping feet', spanish: 'Pisotear fuerte' },
            { word: 'Digging for bones', spanish: 'Cavar buscando huesos' },
            { word: 'Running from a T-Rex', spanish: 'Huyendo de un T-Rex' },
        ]
    },
    'pets-farm': {
        label: 'Pets & Farm Animals',
        labelEs: 'Mascotas y Animales de Granja',
        icon: 'fa-solid fa-horse',
        color: '#F57C00',
        words: [
            { word: 'Dog', spanish: 'Perro' },
            { word: 'Cat', spanish: 'Gato' },
            { word: 'Rabbit', spanish: 'Conejo' },
            { word: 'Hamster', spanish: 'Hámster' },
            { word: 'Goldfish', spanish: 'Pez Dorado' },
            { word: 'Parrot', spanish: 'Loro' },
            { word: 'Turtle', spanish: 'Tortuga' },
            { word: 'Cow', spanish: 'Vaca' },
            { word: 'Pig', spanish: 'Cerdo' },
            { word: 'Sheep', spanish: 'Oveja' },
            { word: 'Horse', spanish: 'Caballo' },
            { word: 'Chicken', spanish: 'Gallina' },
            { word: 'Rooster', spanish: 'Gallo' },
