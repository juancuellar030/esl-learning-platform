...
const TakeTest = (function () {
    ...
    const STUDENT_DATA = {
        ...
        'Group 3C': ['ACOSTA PARRA SALOMÓN', 'ÁVILA ORTEGA GABRIELA', 'AVILÉS DUSSÁN MATHIAS', 'BARRERO GÓMEZ SANTIAGO', 'BARRETO RAMIREZ NHARA ISABELA', 'BASTOS CÁRDENAS SIMÓN', 'BUITRAGO JAVELA EMMA', 'CALLEJAS SOSA EMILIA', 'CASTILLO ROJAS GABRIELA', 'DIAZ CARVAJAL ARTURO', 'JIMÉNEZ BOHADA EMILIANO', 'MEJÍA BORRERO MARIANA', 'MORALES FARFÁN MARTINA', 'OSORIO RUIZ JUAN ANDRÉS', 'ROBLEDO SANTANA SALOME', 'RODRIGUEZ ALVAREZ MARTIN ANDRES', 'ROJAS CLAROS SELENE', 'ROJAS SANDOVAL AVRIL CATALINA', 'SANCHEZ HERNANDEZ ISAAC', 'SILVA BAHAMÓN MANUEL FELIPE', 'SOTELO BRAVO JUAN JOSE', 'TOVAR VARGAS GABRIELA', 'TRIVIÑO GARCÍA YULIANY'],
        ...
        'Group 5B': ['ACERO SOTO DANNA SOFIA', 'AGUIRRE POLANIA MARTHA LUCIA', 'AGUIRRE SANTOFIMIO GABRIELA', 'ANDRADE TAMAYO ANA ISABEL', 'AREVALO GONZALEZ ANGELA MARÍA', 'CHACÓN RUJANA ZAHIRA SOFÍA', 'CLAROS AGUDELO ARIADNA CLAROS', 'ESPINOSA BUSTACARA ANA ISABELLA', 'GUIO QUINTERO JUAN PABLO', 'HERNANDEZ PINEDA JULIAN DAVID', 'MEJÍA BORRERO JUAN ESTEBAN', 'MONJE ORDOÑEZ MARÍA VICTORIA', 'MOSQUERA BAYLÓN KEVIN SAMUEL', 'OBREGÓN SÁNCHEZ JUAN MARTÍN', 'ORTEGA CORTÉS NICOLL MARIANA', 'ORTIZ GONZÁLEZ RAFAEL THOMAS', 'PALACIOS SANCHÉZ MARÍA ANTONIA', 'PARRA VITOVIZ NICOLAS MAURICIO', 'PERDOMO GRAFFE LUCIANA', 'PINCHAO VALENZUELA MARTÍN', 'ROJAS PAYAN GABRIEL DAVID', 'SORA ORTIZ JERÓNIMO', 'TOVAR BAHAMÓN SAMUEL DAVID', 'TRUJILLO TORREJANO LENIN SANTIAGO', 'VERGARA MOLANO JUAN FELIPE', 'VILLARREAL BASTIDAS IANN SANTIAGO', 'ZORRO FERNÁNDEZ SALOMÉ'],
